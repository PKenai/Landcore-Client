...
SpellInfo = {
  ['Default'] = {
    ...
    ['Testebeam'] =                {id = 999, words = 'testebeam',             exhaustion = 0,     premium = false, type = 'Instant', icon = 'energybeam',             mana = 0,      level = 1,  soul = 0, group = {[1] = 2000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}, parameter = true},
